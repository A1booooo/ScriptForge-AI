...
- `apps/web`
  - 提供 T04/T05/T08/T09 前端章节输入工作台
  - 当前能力边界包含章节输入、改编模式选择、提交状态展示、mock 剧本摘要、Chapter Analyzer deterministic Demo analysis、Generated YAML 基线、Edited YAML 编辑、shared validator runtime 校验结果、`.yaml` 导出、轻量 Preview checks、Scene Board 和 Character Bible
...
T04/T05/T08/T09/T10 对应的前端工作台，当前页面能力包括：
...
- 成功后展示结果工作台：
  ...
  - 提示当前 Preview Checks 仍是 lightweight panel；shared validator runtime 已用于 Edited YAML 校验，Chapter Analyzer / Scene Board / Character Bible 仍展示 generated draft 相关参考视图，其中 Chapter Analyzer 额外使用 submitted chapters snapshot 做 deterministic Demo analysis
...
T04/T05/T06/T07/T08/T09 相关依赖及用途：
